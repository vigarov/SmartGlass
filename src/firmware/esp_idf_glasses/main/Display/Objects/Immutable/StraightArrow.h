...
namespace SmartGlasses{
    ...
    public:
        StraightArrow(const std::stirng& name, bool overwrites = false, pixel_pair_t offsets = {0,0}, unsigned char priority = 1): ConstantContent(name,overwrites,offsets,priority) {
