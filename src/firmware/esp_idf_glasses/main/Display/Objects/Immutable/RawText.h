...
namespace SmartGlasses{
    ...
    public:
        RawText(const std::string& s) : RawText(s,false,{0,0},0,1){}
        RawText(const std::string& s, bool overwrites, pixel_pair_t offsets = {0,0}, unsigned char animate = false, unsigned char priority = 1) : RawText(s,ASCII8x8,overwrites,std::move(offsets),animate,priority) {}
