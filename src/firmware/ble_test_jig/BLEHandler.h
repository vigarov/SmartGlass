...
namespace SmartGlasses{   
    ...
    #define IMU_SERVICE_MOTION_CHAR_UUID "8190b029-6844-42db-88ab-5c5866b0c1a4"
    #define IMU_SERVICE_GRANNY_CHAR_UUID "3bd2edf6-7568-43af-a23d-01d8ade86471"
    ...
    public:
      ...
      BLECharacteristic* granny_fallen_char;
      BLECharacteristic* motion_det_char;
    private:
        /**
