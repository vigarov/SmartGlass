...
<p class="notice--warning"> The code used in the demo of 03/06 can be found in in the branch [victor_idleApplication1](https://github.com/vigarov/SmartGlass/tree/victor_idleApplication1)
</p>
